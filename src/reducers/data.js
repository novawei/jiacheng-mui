...
function listReducer(state, action) {
  switch (action.type) {
    case actionType.D_LIST_LOADING:
      return state.setIn(['list', 'loading'], true);
    case actionType.D_LIST_SUCCESS:
      ...
      return state;
    case actionType.D_LIST_FAILURE:
...
function detailReducer(state, action) {
  switch (action.type) {
    case actionType.D_DETAIL_LOADING:
      return state.setIn(['detail', 'loading'], true);
    case actionType.D_DETAIL_SUCCESS:
      ...
      return state;
    case actionType.D_DETAIL_FAILURE:
